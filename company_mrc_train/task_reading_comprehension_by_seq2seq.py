...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if logs['loss'] <= self.lowest:
            predict_to_file(valid_data, "mrc_event_extraction_by_seq2seq.tsv")

            self.lowest = logs['loss']
            model.save_weights('./task_reading_comprehension_by_seq2seq.weights')
...
if __name__ == '__main__':
    ...
    model.load_weights('./task_reading_comprehension_by_seq2seq.weights')